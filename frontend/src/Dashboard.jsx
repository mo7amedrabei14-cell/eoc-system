...
const [isModalOpen, setIsModalOpen] = useState(false);
  ...
  >
    + إنشاء مهمة
      ...
      <div className={isTableExpanded ? `fixed inset-4 z-[150] bg-[#0c0c0c] border border-white/10 rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-fade-in-up ${isSidebarOpen ? 'md:right-80 md:left-4' : 'md:right-30 md:left-4'}` : "flex-1 flex flex-col overflow-hidden relative"}>
