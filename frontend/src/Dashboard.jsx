...
const [isModalOpen, setIsModalOpen] = useState(false);
  ...
  >
    + إنشاء مهمة
      ...
      <div className={isTableExpanded ? "fixed top-4 bottom-4 left-4 right-4 z-[150] bg-[#0c0c0c] border border-white/10 rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-fade-in-up" : "flex-1 flex flex-col overflow-hidden relative"}>
